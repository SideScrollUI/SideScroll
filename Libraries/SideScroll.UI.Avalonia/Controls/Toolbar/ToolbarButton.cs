...
public class ToolbarButton : Button, IDisposable
{
	...
	protected Color Color => (ImageResource as ImageColorView)?.Color ?? SideScrollTheme.IconForeground.Color;

	protected Color? HighlightColor => (ImageResource as ImageColorView)?.HighlightColor ?? SideScrollTheme.IconForegroundHighlight.Color;
	...
	protected IImage? DisabledImage => _disabledImage ??= SvgUtils.TryGetSvgColorImage(ImageResource, SideScrollTheme.IconForegroundDisabled.Color);
