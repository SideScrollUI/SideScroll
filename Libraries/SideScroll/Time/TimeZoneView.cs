...
public class TimeZoneView : IComparable
{
	...
	public static TimeZoneView Utc { get; private set; } = new("Utc", "Utc", TimeZoneInfo.Utc);
	public static TimeZoneView Local { get; private set; } = new("Local", "Local", TimeZoneInfo.Local);
