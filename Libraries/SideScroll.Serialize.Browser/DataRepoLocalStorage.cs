	...
	: DataRepo(repoPath, repoName, useJson: true)
{
	...
	/// </summary>
	public override DataRepoInstance<T> Open<T>(string groupId, bool indexed = false)
	{
	...
	/// </summary>
	public override DataRepoView<T> OpenView<T>(string groupId, bool indexed = false, int? maxItems = null)
	{
	...
	public override void DeleteAll(Call? call, Type type, string? groupId = null)
	{
		...
		string indexPath = Paths.Combine(groupPath, PrimaryIndexFileName);
